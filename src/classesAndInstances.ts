abstract class Department { //if a class is marked as abstrtact then you cannot instantiate that class anymore, bacuse abstract class means that it is only a blueprint or a shell for other classes to extend this class and use its properties and methods. YOu can only instantiate the classes which extends the abstract class.
    ...
    constructor(protected readonly id: string, public name: string) { //just like const we can mark a class property as readonly which cannot be changed later anywhere. 
      // this.id = id;
      // this.name = n;
  ...
  class AccountingDepartment extends Department {
    ...
    private constructor(id: string, private reports: string[]) {  //to create a singleton class always add private in front of constructor, that way outside the class you cannot create multiple instances of this class. You can only craete a single instance inside this class only as below getInstances()
      super(id, 'Accounting');
